...
public class Build 
{
	...
	// ************************************************************************************************ //
	   ...
	   private static ArrayList <String> complete_set = new ArrayList<>();
	...
	// ************************************************************************************************ //
			...
			// ******************************************************************** //
				...
				private static void isValid()
				{
					...
					for(int h=0;h<build_size;h++)
					{
							gp_part = parts.get(h);
							temp.add(gp_part.getType()); // temp 
					...
					complete_set.removeAll(temp);
					//System.out.print(complete_set);
					temp_size = complete_set.size();
					String d; 
